package antonioguerrero.ioc.fithub.client;
...
/**
 * Proves per verificar la pantalla d'instal·lacions.
 * <p>
 * Autor: Antonio Guerrero
 * Versió: 1.0
 */
@RunWith(AndroidJUnit4.class)
public class TestPantallaInstallacions {
    ...
    /**
     * Prova per verificar que el RecyclerView de les instal·lacions té almenys un element.
     */
    @Test
    public void testContenidoRecyclerView() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.et_correu_usuari)).perform(ViewActions.typeText(Constants.CLIENT_EMAIL));
        Espresso.onView(ViewMatchers.withId(R.id.et_contrasenya)).perform(ViewActions.typeText(Constants.CLIENT_CONTRASENYA));
        ...
        onView(withId(R.id.rvInstallacions)).check((view, noViewFoundException) -> {
