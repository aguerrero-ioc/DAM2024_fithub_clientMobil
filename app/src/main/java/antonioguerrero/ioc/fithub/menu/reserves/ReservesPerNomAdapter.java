...
public class ReservesPerNomAdapter extends RecyclerView.Adapter<ReservesPerNomAdapter.ViewHolder> {
     ...
     */
    public ReservesPerNomAdapter(Context context, List<HashMap<String, String>> classesDirigidesList) {
